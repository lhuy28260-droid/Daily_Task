...
CREATE TABLE rooms (
    ...
    status VARCHAR(50) DEFAULT 'active' -- Mặc định là đang hoạt động
);
...
CREATE TABLE showtimes (
    ...
    ticket_price DECIMAL(10, 2) NOT NULL CHECK (ticket_price >= 0), -- Giá vé >= 0
...
(1, 'Trần Thị B', '0987654321'), -- Vị khách sẽ hủy vé sau này
